...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Első",sLast:"Utolsó",sNext:"Következő",sPrevious:"Előző"},sEmptyTable:"A táblázatban nincs adat",sInfo:"Mutatom _START_-től _END_-ig a _TOTAL_ sorból",sInfoEmpty:"Mutat 0 tól 0 -ig 0 sorból",sInfoFiltered:"(szűrve _MAX_ sorból)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Egy lapon _MENU_ sort mutat",sLoadingRecords:"Betöltés...",sProcessing:"Feldolgozás...",sSearch:"Keresés:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Nem találtam ezt a kifjezést"},oSearch:k.extend({},u.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};G(u.defaults);u.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
